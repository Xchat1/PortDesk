...
final class Localization: ObservableObject, @unchecked Sendable {
    ...
    private static let zh: [String: String] = [
        ...
        "settings_appearance_desc": "选择 PortDeck 的明暗主题。跟随系统会随 macOS 自动切换。",
        "settings_appearance_auto": "跟随系统",
        "settings_appearance_light": "浅色",
        "settings_appearance_dark": "深色",
        "settings_appearance_cur": "当前主题",
        ...
        "detail_system_protected": "系统或 Apple 签名进程受保护。PortDeck 无法关闭该服务。",
        ...
        "logs_prev": "上一页",
        "logs_next": "下一页",
        "logs_clear_title": "清空所有操作日志？",
        "logs_clear_desc": "确定要删除全部 %d 条记录吗？此操作无法撤销。",
        "logs_clear_confirm": "清空日志",
        "logs_delete_title": "删除这条记录？",
        "logs_delete_desc": "确定要删除这条操作日志吗？此操作无法撤销。",
        "logs_delete_confirm": "删除",
    ...
    private static let en: [String: String] = [
        ...
        "detail_system_protected": "System and Apple-signed processes are protected. PortDeck cannot shut down this service.",
        ...
        "logs_page": "Page %d of %d",
        "logs_total": "%d entries",
        "logs_prev": "Previous",
        "logs_next": "Next",
        "logs_clear_title": "Clear all operation logs?",
        "logs_clear_desc": "Delete all %d records? This cannot be undone.",
        "logs_clear_confirm": "Clear Logs",
        "logs_delete_title": "Delete this entry?",
        "logs_delete_desc": "Delete this operation log? This cannot be undone.",
        "logs_delete_confirm": "Delete",
        
        // SettingsView
        "settings_lang_title": "Interface Language",
        "settings_lang_zh": "Chinese",
        "settings_lang_en": "English",
        "settings_lang_cur": "Current",
        "settings_appearance_title": "Appearance",
        "settings_appearance_desc": "Choose PortDeck's light or dark theme. System follows the macOS setting automatically.",
        "settings_appearance_auto": "System",
        "settings_appearance_light": "Light",
        "settings_appearance_dark": "Dark",
        "settings_appearance_cur": "Current",
        "settings_refresh_title": "Refresh Interval",
        "settings_refresh_desc": "How often the app auto-scans active ports in the background.",
